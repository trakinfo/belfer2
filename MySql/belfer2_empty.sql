...
CREATE TABLE `szkola` (
  ...
  CONSTRAINT `FK_szkola_typy_szkol` FOREIGN KEY (`IdTypSzkoly`) REFERENCES `typy_szkol` (`ID`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ALLOW_INVALID_DATES,ERROR_FOR_DIVISION_BY_ZERO,TRADITIONAL,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `ChangePassword`(IN Nick varchar(10),IN NewPwd binary(64),IN UserName varchar(10),IN HostIP varchar(15))
BEGIN
	UPDATE user SET Password=NewPwd,User=UserName,ComputerIP=HostIP WHERE Login=Nick;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2017-04-20  8:55:33
